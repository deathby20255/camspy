...
time.sleep(0.9)
os.system(delet)
print("BY Deathby2021")
      
time.sleep(1.2)
os.system(delet)
print('this is for education purpose only. not responsible for actions.')
time.sleep(5)
os.system(delet)
time.sleep(4)
os.system(delet)
print("Welcome to CamSpy")
time.sleep(4)
print("Please select country to scan for open ip adresses :")
print("""
